...
#                 # Always read the frame from video for the target frame
#                 with self.video_lock:
...
#                             self.current_frame_image = frame.copy()
#                         else:
#                             logging.warning(f"Failed to read frame {target_frame}, using cached frame")
...
#                     else:
#                         logging.warning("Video capture not available, using cached frame")
#                         frame = self.current_frame_image.copy() if self.current_frame_image is not None else self._get_black_frame()
...
#                 # Always get the frame for the current index (this will read from video)
